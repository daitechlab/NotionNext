...
const BLOG = {
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://img2.imgtp.com/2024/05/10/ulcYm6me.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
