...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '卒迹', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '日拱一卒，功不唐捐', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.breadth.top', // 网站地址
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/breadthstudio', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://cdn1.iconfinder.com/data/icons/blogging-and-content-marketing/100/blog-03-512.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'DevTech', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Breadth’s bizarre adventure', // 站点描述，被notion中的页面描述覆盖
